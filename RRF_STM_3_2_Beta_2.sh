...
sudo apt -q update 
sudo apt install \ 
	duetsoftwareframework=3.2.0-beta2 \
	duetcontrolserver=3.2.0-beta2 \
	duetruntime=3.2.0-beta2 \
	duetsd=1.1.0 \
	duetsoftwareframework=3.2.0-beta2 \
	duettools=3.2.0-beta2 \
	duetwebcontrol=3.2.0-beta2 \
	duetwebserver=3.2.0-beta2 \
	reprapfirmware=3.2.0-beta2-1 \
	--allow-downgrades