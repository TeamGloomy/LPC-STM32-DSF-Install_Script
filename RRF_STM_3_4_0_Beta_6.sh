echo "-----This will install the STM Version of DSF for 3.4.0 Beta 6-----"
...
sudo apt install \
    ...
    duetcontrolserver=3.4-b6 \
    duetruntime=3.4-b6 \
    duetsd=1.1.0 \
    duettools=3.4-b6 \
    duetwebcontrol=3.4-b6 \
    duetwebserver=3.4-b6 \
    reprapfirmware=3.4-b6-1 \
    --allow-downgrades
sudo apt-mark hold \
    duetsoftwareframework \
    duetcontrolserver \
