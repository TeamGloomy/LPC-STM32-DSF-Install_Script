echo "-----This will install the STM Version of DSF for 3.4.0 Beta 2-----"
...
sudo apt install \
    ...
    duetcontrolserver=3.4-b2 \
    duetruntime=3.4-b2 \
    duetsd=1.1.0 \
    duettools=3.4-b2 \
    duetwebcontrol=3.4-b2 \
    duetwebserver=3.4-b2 \
    reprapfirmware=3.4-b2-1 \
    --allow-downgrades
sudo apt-mark hold \
    duetsoftwareframework \
    duetcontrolserver \
