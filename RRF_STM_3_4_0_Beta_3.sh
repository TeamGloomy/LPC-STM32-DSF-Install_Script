echo "-----This will install the STM Version of DSF for 3.4.0 Beta 3-----"
...
sudo apt install \
    ...
    duetcontrolserver=3.4-b3 \
    duetruntime=3.4-b3 \
    duetsd=1.1.0 \
    duettools=3.4-b3 \
    duetwebcontrol=3.4-b3 \
    duetwebserver=3.4-b3 \
    reprapfirmware=3.4-b3-1 \
    --allow-downgrades
sudo apt-mark hold \
    duetsoftwareframework \
    duetcontrolserver \
